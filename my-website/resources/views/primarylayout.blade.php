...
<body>
    <link rel="stylesheet" href="/css/primarylayout.css">
    ...
    <div class="container navcontainer">
        ...
        <a class="navbar-brand" href="{{route('home')}}">BERGHUUS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mt-2">
                    ...
                    <img src="{{ asset('images/whiteline.png') }}" style="margin-right:70px;" alt="divider" id="nav-line" class="navbar-divider">
